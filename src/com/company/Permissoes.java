...
public enum Permissoes {
    ...
    VISUALIZAR_INFO(4, "Permite a um usuário visualizar as seguintes informações do grupo: Nome, Dono, " +
            "Status e Membros Pertencentes."),
    CRIAR_CARTAO(5, "Permite a um usuário criar um cartão");
